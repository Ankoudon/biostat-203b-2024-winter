...
![](images/Screenshot%202024-01-22%20at%209.51.25.png)
...
3.  Briefly describe what Bash commands `zcat`, `zless`, `zmore`, and `zgrep` do.
    ...
    **zless:**
    ...
    "zless" can display the contents of compressed files in a scrollable manner without actually decompressing it.

    **zmore:**

    "zmore" can display the contents of compressed files line by line without actually decompressing it.
...
They do not match the number of patients listed in the patients.csv.gz file.
...
**Explanation:** This script takes the first 20 lines of the file "pg42671.txt" and then takes the last 5 lines of the first 20 lines, which is the output.
...
This command usually displays the username, terminal, and date and time of the last login.
...
This command displays the information about the currently logged in user, such as username, terminal, login time, idle time, and the current process.
...
***last*** command displays the information about the last logged in users. ***head*** command is used to display the first few lines of the output. So, "last \| head" displays the information about the recent last logged in users.
...
This command displays the time it takes to run the command "sleep 5".
...
This command displays the last 10 commands you have run.
...
1.  Git clone the repository <https://github.com/christophergandrud/Rep-Res-Book> for the book *Reproducible Research with R and RStudio* to your local machine.
    ...
    ![](images/Screenshot%202024-01-19%20at%2015.56.53.png)
...
2.  Open the project by clicking `rep-res-3rd-edition.Rproj` and compile the book by clicking `Build Book` in the `Build` panel of RStudio. (Hint: I was able to build `git_book` and `epub_book` but not `pdf_book`.)
    ...
    ![](images/Screenshot%202024-01-19%20at%2016.06.49.png)
...
![](images/Screenshot%202024-01-19%20at%2016.07.12-01.png)
