...
procedures <- read_csv("~/mimic/hosp/procedures_icd.csv.gz") |>
  ...
  # Make the length of long_title less than 50
...
The number of admissions is highest at 00:00 and decreases until 06:00. However, it increases sharply again at 07:00, and then declines at 08:00. Thereafter, it gradually increases until 18:00.
...
As the length of hospital stay increases, the number of events decreases. Many patients are discharged within days or weeks.
...
Men and women have similar trends. The number of patients in their teens and twenties, both male and female, is high. Also, the number of female patients is higher than that of male patients in all generations. (The number of the oldest people is also somehow high.)
...
lab_los <- mimic_icu_cohort |>
  ...
  labs(title = paste0("Length of ICU stay vs ",
                      "the last available lab measurements before ICU stay"),
       x = "Lab value",
       y = "Length of ICU stay")
...
vital_los_trim <- mimic_icu_cohort |>
  ...
  facet_wrap(~ vital, scales = "free") +
  labs(title = paste0("Length of ICU stay vs ",
  "First vital measurement within the ICU stay (without outlier)"),
  x = "Vital value",
  y = "Length of ICU stay")
...
unit_los <- mimic_icu_cohort |>
  ggplot(aes(x = los, y = first_careunit)) +
  geom_boxplot(outlier.shape = NA) +
  labs(title = "Length of ICU stay vs first ICU unit (without outlier)",
       x = "Length of ICU stay",
       y = "First ICU unit") +
